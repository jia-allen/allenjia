...
const NOTION_NEXT_TEMPLATE_REPOSITORY =
  'https://github.com/tangly1024/NotionNext'

export function normalizeOwnerLink(href) {
  return typeof href === 'string' &&
    href.trim().replace(/\/+$/, '') === NOTION_NEXT_TEMPLATE_REPOSITORY
    ? BLOG.CONTACT_GITHUB
    : href
}
...
export function getCustomMenu({ collectionData, sourcePageSlugs }) {
  ...
  if (menuPages && menuPages.length > 0) {
    menuPages.forEach(e => {
      ...
      e.href = normalizeOwnerLink(e.href)
      if (e.type === 'Menu') {
        menus.push(e)
