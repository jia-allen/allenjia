const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2023-12-26', // 建站日期，用于计算网站运行的第几天
  HEO_FOOTER_SINCE: 2023,
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/jia-allen',
  ...
  HEO_SOCIAL_CARD: true, // 是否显示右侧职业成长入口
  HEO_SOCIAL_CARD_TITLE_1: '成长路线',
  HEO_SOCIAL_CARD_TITLE_2: '前端深度 · 后端能力 · AI Agent',
  HEO_SOCIAL_CARD_TITLE_3: '查看职业规划',
  HEO_SOCIAL_CARD_URL: '/about',

  // 底部统计面板文案
  HEO_POST_COUNT_TITLE: '文章数:',
  HEO_SITE_TIME_TITLE: '建站天数:',
  HEO_SITE_VISIT_TITLE: '全站访问量:',
  HEO_SITE_VISITOR_TITLE: '访客数:',
  HEO_SITE_VISIT_OFFSET: 300, // 展示用历史访问基数，设为 0 则显示真实统计
  HEO_SITE_VISITOR_OFFSET: 50, // 展示用历史访客基数，设为 0 则显示真实统计
